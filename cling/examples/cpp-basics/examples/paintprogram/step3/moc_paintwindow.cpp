...
template <> constexpr inline auto PaintWindow::qt_create_metaobjectdata<qt_meta_tag_ZN11PaintWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(QAction *)>(5, 2, QMC::AccessProtected, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'slotChangePenWidth'
        QtMocHelpers::SlotData<void(QAction *)>(8, 2, QMC::AccessProtected, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'slotChangePenStyle'
...
void PaintWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotChangeColor((*reinterpret_cast<std::add_pointer_t<QAction*>>(_a[1]))); break;
        case 2: _t->slotChangePenWidth((*reinterpret_cast<std::add_pointer_t<QAction*>>(_a[1]))); break;
        case 3: _t->slotChangePenStyle((*reinterpret_cast<std::add_pointer_t<QAction*>>(_a[1]))); break;
        case 4: _t->slotAbout(); break;
        case 5: _t->slotAboutQt(); break;
        case 6: _t->slotLoad(); break;
        case 7: _t->slotSave(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PaintWindow::*)(const QColor & )>(_a, &PaintWindow::colorChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void PaintWindow::colorChanged(const QColor & _t1)
{
