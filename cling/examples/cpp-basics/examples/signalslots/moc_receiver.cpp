...
template <> constexpr inline auto Receiver::qt_create_metaobjectdata<qt_meta_tag_ZN8ReceiverE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'anOtherSlot'
        QtMocHelpers::SlotData<void(int, QObject *)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 4 }, { QMetaType::QObjectStar, 5 },
        }}),
    };
...
void Receiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->aSlot(); break;
        case 1: _t->anOtherSlot((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QObject*>>(_a[2]))); break;
        default: ;
        }
    }
}
