...
template <> constexpr inline auto DiagramScene::qt_create_metaobjectdata<qt_meta_tag_ZN12DiagramSceneE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'itemMoved'
        QtMocHelpers::SignalData<void(DiagramItem *, const QPointF &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void DiagramScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->itemMoved((*reinterpret_cast<std::add_pointer_t<DiagramItem*>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QPointF>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DiagramScene::*)(DiagramItem * , const QPointF & )>(_a, &DiagramScene::itemMoved, 0))
            return;
    }
}
