...
namespace {
struct qt_meta_tag_ZN10ScreenshotE_t {};
} // unnamed namespace

template <> constexpr inline auto Screenshot::qt_create_metaobjectdata<qt_meta_tag_ZN10ScreenshotE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Screenshot, qt_meta_tag_ZN10ScreenshotE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Screenshot::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ScreenshotE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ScreenshotE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10ScreenshotE_t>.metaTypes,
    nullptr
} };
...
void *Screenshot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ScreenshotE_t>.strings))
