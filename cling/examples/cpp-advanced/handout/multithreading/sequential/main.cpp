...
static const bool SEQUENTIAL = true;    // Set to false to test your code
static const bool OPTIONALPART = false; // Set to true to enable the optional part
