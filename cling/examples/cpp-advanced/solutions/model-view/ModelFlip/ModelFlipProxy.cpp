...
void ModelFlipProxy::setSourceModel(QAbstractItemModel* sourceModel)
{
    connect(sourceModel, &QAbstractItemModel::dataChanged, this, &ModelFlipProxy::sourceModelDataChanged);
    QAbstractProxyModel::setSourceModel(sourceModel);
}

void ModelFlipProxy::sourceModelDataChanged(const QModelIndex& topLeft, const QModelIndex& bottomRight)
{
